...
from trippy.models.trip import RiskFlag, RiskSeverity, Segment, Stay, Trip
...
_INTL_HUB_CODES = {
    "YYZ", "YVR", "YUL", "ORD", "LAX", "JFK", "EWR", "SFO", "LHR", "CDG",
    "AMS", "FRA", "DXB", "HND", "NRT", "ICN", "SIN", "BKK", "SYD",
}
...
class FrictionDetector:
    ...
    def audit(self, trip: Trip) -> list[RiskFlag]:
        ...
        logger.info(
            "FrictionDetector: %d risk(s) found for trip %r",
            len(risks), trip.trip_id
        )
        return risks
    ...
    def _check_passport_expiry(self, trip: Trip) -> list[RiskFlag]:
        ...
        for traveler in trip.travelers:
            if not traveler.passport_expiry:
                ...
                sev = RiskSeverity.CRITICAL if traveler.passport_expiry < trip.end_date else RiskSeverity.HIGH
                risks.append(RiskFlag(
