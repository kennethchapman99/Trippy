...
TRIP_SHAPE_LLM_MODEL: str = os.environ.get("TRIPPY_TRIP_SHAPE_LLM_MODEL", PLANNING_LLM_MODEL)
TRIP_SHAPE_LLM_ENABLED: bool = _bool("TRIPPY_TRIP_SHAPE_LLM_ENABLED", bool(ANTHROPIC_API_KEY))
