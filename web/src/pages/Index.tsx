      ...
      <div className="max-w-6xl mx-auto px-6 py-10 md:py-12">
        ...
        {isLoading && (
          <div className="flex items-center justify-center py-24 text-muted-foreground gap-3">
            ...
            <span className="font-bold">Connecting to Hermes…</span>
          </div>
        )}
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {allTrips.map((t, i) => {
                ...
                return (
                  ...
                  >
                    {/* Cover */}
                    <div className="relative h-32" style={{ background: cover }}>
                      <span className="absolute top-3 left-3 text-4xl drop-shadow-md">{emoji}</span>
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex gap-2 mt-4">
                        {[
                          { i: Plane, on: t.planning_completeness > 25 },
                          { i: Hotel, on: t.planning_completeness > 50 },
                          { i: Car, on: t.planning_completeness > 70 },
                          { i: Sparkles, on: t.planning_completeness > 85 },
                        ].map((p, idx) => (
                          <div
                            key={idx}
